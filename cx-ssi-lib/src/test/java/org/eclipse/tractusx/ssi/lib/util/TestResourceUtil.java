...
public class TestResourceUtil {
    ...
    private static String VERIFIABLE_CREDENTIAL_ALUMNI = "verifiable-credential/alumni-credential.json";
    private static String VERIFIABLE_PRESENTATION_ALUMNI = "verifiable-presentation/alumni-presentation.json";
    ...
    private static InputStream readResource(String resource) {
        final InputStream inputStream = KeyResourceLoader.class.getClassLoader().getResourceAsStream(resource);
