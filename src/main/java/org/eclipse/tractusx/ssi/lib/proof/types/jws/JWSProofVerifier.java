...
public class JWSProofVerifier implements IVerifier {
    ...
    private boolean validateVerificationRelationShip(
        ...
        for (Object o : verificationRelationShip) {
            if (o instanceof URI) {
                ...
                URI relationShip = URI.create((String) mapRelationShip.get("id"));
                if (relationShip.equals(verificationMethodId)) {
                    return true;
                }
            }
