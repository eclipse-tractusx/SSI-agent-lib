 ...
 */
public class Ed25519ProofConfiguration extends Proof {
   ...
   * @param json the json
   */
  public Ed25519ProofConfiguration(Map<String, Object> json) {
    super(json);

    if (!ED25519_VERIFICATION_KEY_2018.equals(json.get(TYPE))) {
      throw new IllegalArgumentException("Invalid Ed25519ProofConfiguration Type: " + json);
    }
